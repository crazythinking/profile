...
(
	...
	APP_CD VARCHAR2(50),
	-- 菜单代码 : 接口代码所属菜单代码
	MENU_CD VARCHAR2(30) NOT NULL UNIQUE,
	-- 菜单名称
...
(
	...
	INTERF_CD VARCHAR2(50) NOT NULL UNIQUE,
	-- 接口名称
...
COMMENT ON COLUMN PROFILE_MENU.MENU_CD IS '菜单代码 : 接口代码所属菜单代码';
...
COMMENT ON COLUMN PROFILE_MENU_INTERF.INTERF_CD IS '接口代码 : 作为Auth的权限标识，以及前端的接口标识';
COMMENT ON COLUMN PROFILE_MENU_INTERF.INAME IS '接口名称';
COMMENT ON COLUMN PROFILE_MENU_INTERF.MENU_CD IS '菜单代码 : 接口代码所属菜单代码';
