...
import net.engining.profile.invoker.check.CheckSameDepartmentChangedInvoker;
import net.engining.profile.invoker.department.UpdateProfileBranchInvoker;
...
@FlowDefinition(
        ...
        invokers = {
                ...
                // 校验部门信息是否发生修改
                CheckSameDepartmentChangedInvoker.class,
                // 修改部门表记录
                UpdateProfileBranchInvoker.class,
                // 记录操作日志
...
@Service
public class UpdateDepartmentFlow extends AbstractFlow {
}
